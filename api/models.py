...
class Instructor(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, null=True, related_name='instructor')
...
class QuizSession(models.Model):
    ...
    served_questions = models.ManyToManyField(QuestionMultipleChoice, related_name='served_in_sessions', blank=True)
    current_question = models.ForeignKey(QuestionMultipleChoice, on_delete=models.CASCADE, null=True, blank=True,
...
class UserResponse(models.Model):
    student = models.ForeignKey(QuizSessionStudent, on_delete=models.CASCADE, related_name='responses')
    question = models.ForeignKey(QuestionMultipleChoice, on_delete=models.CASCADE, related_name='responses')
