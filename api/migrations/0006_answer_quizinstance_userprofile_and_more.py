    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quizzes', models.ManyToManyField(through='api.QuizInstance', to='api.quiz')),
                ('user_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.userprofile')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz_instance', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.quizinstance')),
            ],
        ),
        migrations.AddField(
            model_name='answer',
